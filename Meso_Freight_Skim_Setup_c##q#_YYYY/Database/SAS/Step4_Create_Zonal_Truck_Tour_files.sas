...
filename corresp "&sasin.&conformity.\sz_zn09_meso.csv";      *** -- subzone-zone-mesozone correspondence file -- ***;
  ...
  *##-- Output --##;
filename out1 "&outdir.\cmap_data_zone_skims_&year..csv";            *** -- New output file of Zonal skims -- ***;
filename out2 "&outdir.\cmap_data_zone_centroids_&year..csv";        *** -- New output file of CMAP zone centroid coordinates -- ***;
filename out3 "&outdir.\cmap_data_zone_employment_&year..csv";       *** -- New output file of CMAP zonal employment -- ***;
