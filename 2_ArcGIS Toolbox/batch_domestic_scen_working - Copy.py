...
scenario = str(arcpy.GetParameterAsText(1))
...
currentDir = "S:\\AdminGroups\\ResearchAnalysis\\kcc\\FY25\\MFN\\proUpdate\\finalGDB"                                                                  # working directory 
programDir = currentDir + "\\mfn_programs\\current_batchin_SCRIPTS"
gdbDir = currentDir + "\\MFN_currentFY25.gdb"
