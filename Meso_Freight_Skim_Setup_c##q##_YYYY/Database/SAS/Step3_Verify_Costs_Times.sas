/* STEP3_VERIFY_COSTS_TIMES.SAS
      Craig Heither, revised 03-09-2017
...
%let flagYr=%scan(&sysparm,2);					                            *** -- Flag Year -- ***;
%let year=%scan(&sysparm,3);					                            *** -- Flag Year -- ***; 
%put &flagYr;
%put &scen;
filename out0 "port_detail_review_&year..csv";
filename out1 "port_summary_review_&year..csv";
 ...
 ** inland water [1] only available in selected locations so do not include here **;
 ...
 ** ONLY Options should be modes listed directly above **;
 array tm{44} time2 time5-time12 time15-time30 time33-time38 time40-time45 time48-time54; 
 array cs{44} cost2 cost5-cost12 cost15-cost30 cost33-cost38 cost40-cost45 cost48-cost54; 
  time=0; cost=0;
  do i=1 to 44;
 ...
 ** Minimum Options available to all zones should be: water ports [1,2], FTL direct [31], LTL direct [46], air [47-50] **;
  if &flagYr=0 then do;
	x1= nmiss(time1,time2,time31,time46,time47,time48,time50,cost1,cost2,cost31,cost46,cost47,cost48,cost50);
  end;
  else do;
 ...
 ** No CMAP water [2 only] or air [48-50] should be available **;
  if &flagYr=0 then do;
    time= max(time2,time48,time50);
    cost= max(cost2,cost48,cost50);
  	end;
  else
  	do;
 ...
 ** ONLY air [47-50] and international water [51-54] should be available to CMAP zones **;
  if &flagYr=0 then do;
	x1= nmiss(time47,time48,time50,time51,time52,time53,time54,cost47,cost48,cost50,cost51,cost52,cost53,cost54); 
  end;
  else do;
 ...
 ** Minimum Options available to all zones should be: FTL direct [31], LTL direct [46], air [47-50], international water [51-54] **;
  if &flagYr=0 then do;
	x1= nmiss(time31,time46,time47,time48,time50,time51,time52,time53,time54,cost31,cost46,cost47,cost48,cost50,cost51,cost52,cost53,cost54); 
  end;
  else do;
...
/* 
 data null; file out0; 
 put "===============================" / "Detail: Kansas City to Eastern Asia" / "Origin,Destination,Location,Port_nameNB,Port_mesozoneNB,GCD,MinShipTime,MinShipCost";   
   data x; set b1; 
      file out0 mod dsd;
	   *****put Origin Destination Location Port_name Port_mesozone GCD MinShipTime MinShipCost;	
	   put Origin Destination Location Port_nameNB Port_mesozoneNB GCD MinShipTime MinShipCost
*/
 proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1; put "===============================" / "Summary: Kansas City to Eastern Asia - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;	 

 proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put "===============================" / "Summary: Kansas City to Eastern Asia - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;	 
...
/*  
  ...
  */
   ...
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Kansas City to Europe - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;	 
	   
 proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put "===============================" / "Summary: Kansas City to Europe - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;	   
...
*/
   ...
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Kansas City to Rest of Americas - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;	
 
 proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put "===============================" / "Summary: Kansas City to Rest of Americas - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;	 
...
*/	  
   ...
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Chicago to Eastern Asia - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;	  

   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Chicago to Eastern Asia - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;
...
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Chicago to Europe - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;	  

   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Chicago to Europe - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;	
...
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Chicago to Rest of Americas - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;

   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Chicago to Rest of Americas - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;	   
...
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Denver to Eastern Asia - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;
   
   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Denver to Eastern Asia - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;
...
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Denver to Europe - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;

   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Denver to Europe - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;
...
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Denver to Rest of Americas - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;
	   
   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Denver to Rest of Americas - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;
...
** ### -- to Eastern Asia -- ### **;
*--------------------------------------------------------------*;
data a1; set a(where=(Origin=176));
data b1; set a1(where=(Destination in (316,374,403,418,456)));
  proc sort; by Origin Destination;
 /* 
 data null; file out0 mod; 
 put "===============================" / "Detail: Atlanta to Eastern Asia" / "Origin,Destination,Location,Port_name,Port_mesozone,GCD,MinShipTime,MinShipCost";   
   data x; set b1; 
      file out0 mod dsd; put Origin Destination Location Port_name Port_mesozone GCD MinShipTime MinShipCost;  
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Atlanta to Eastern Asia - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;
   
   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Atlanta to Eastern Asia - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;
...
/*  
 data null; file out0 mod; 
 put "===============================" / "Detail: Atlanta to Europe" / "Origin,Destination,Location,Port_name,Port_mesozone,GCD,MinShipTime,MinShipCost";   
   data x; set b1; 
      file out0 mod dsd; put Origin Destination Location Port_name Port_mesozone GCD MinShipTime MinShipCost;    
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Atlanta to Europe - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;

   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Atlanta to Europe - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;
...
/*  
 data null; file out0 mod; 
 put "===============================" / "Detail: Atlanta to Rest of Americas" / "Origin,Destination,Location,Port_name,Port_mesozone,GCD,MinShipTime,MinShipCost";   
   data x; set b1; 
      file out0 mod dsd; put Origin Destination Location Port_name Port_mesozone GCD MinShipTime MinShipCost;     
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Atlanta to Rest of Americas - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;
	   
   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Atlanta to Rest of Americas - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;	   
...
** ### -- to Eastern Asia -- ### **;
*--------------------------------------------------------------*;
data a1; set a(where=(Origin=214));
data b1; set a1(where=(Destination in (316,374,403,418,456)));
  proc sort; by Origin Destination;
 /* 
 data null; file out0 mod; 
 put "===============================" / "Detail: Las Vegas to Eastern Asia" / "Origin,Destination,Location,Port_name,Port_mesozone,GCD,MinShipTime,MinShipCost";   
   data x; set b1; 
      file out0 mod dsd; put Origin Destination Location Port_name Port_mesozone GCD MinShipTime MinShipCost;  
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Las Vegas to Eastern Asia - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;
   
   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Las Vegas to Eastern Asia - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;
...
/*  
 data null; file out0 mod; 
 put "===============================" / "Detail: Las Vegas to Europe" / "Origin,Destination,Location,Port_name,Port_mesozone,GCD,MinShipTime,MinShipCost";   
   data x; set b1; 
      file out0 mod dsd; put Origin Destination Location Port_name Port_mesozone GCD MinShipTime MinShipCost;    
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Las Vegas to Europe - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;

   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Las Vegas to Europe - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;
...
/*  
 data null; file out0 mod; 
 put "===============================" / "Detail: Las Vegas to Rest of Americas" / "Origin,Destination,Location,Port_name,Port_mesozone,GCD,MinShipTime,MinShipCost";   
   data x; set b1; 
      file out0 mod dsd; put Origin Destination Location Port_name Port_mesozone GCD MinShipTime MinShipCost;     
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Las Vegas to Rest of Americas - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;
	   
   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Las Vegas to Rest of Americas - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;	   	   
...
** ### -- to Eastern Asia -- ### **;
*--------------------------------------------------------------*;
data a1; set a(where=(Origin=231));
data b1; set a1(where=(Destination in (316,374,403,418,456)));
  proc sort; by Origin Destination;
 /* 
 data null; file out0 mod; 
 put "===============================" / "Detail: Cincinnati to Eastern Asia" / "Origin,Destination,Location,Port_name,Port_mesozone,GCD,MinShipTime,MinShipCost";   
   data x; set b1; 
      file out0 mod dsd; put Origin Destination Location Port_name Port_mesozone GCD MinShipTime MinShipCost;  
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Cincinnati to Eastern Asia - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;
   
   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Cincinnati to Eastern Asia - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;
...
/*  
 data null; file out0 mod; 
 put "===============================" / "Detail: Cincinnati to Europe" / "Origin,Destination,Location,Port_name,Port_mesozone,GCD,MinShipTime,MinShipCost";   
   data x; set b1; 
      file out0 mod dsd; put Origin Destination Location Port_name Port_mesozone GCD MinShipTime MinShipCost;    
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Cincinnati to Europe - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;

   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Cincinnati to Europe - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;
...
/*  
 data null; file out0 mod; 
 put "===============================" / "Detail: Cincinnati to Rest of Americas" / "Origin,Destination,Location,Port_name,Port_mesozone,GCD,MinShipTime,MinShipCost";   
   data x; set b1; 
      file out0 mod dsd; put Origin Destination Location Port_name Port_mesozone GCD MinShipTime MinShipCost;     
*/
   proc summary nway data=b1; class Port_nameNB; id Port_mesozoneNB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Cincinnati to Rest of Americas - NonBulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameNB Port_mesozoneNB Frequency;
	   
   proc summary nway data=b1; class Port_nameB; id Port_mesozoneB; var GCD; output out=x N=Frequency; proc sort data=x; by descending Frequency;
     data null; file out1 mod; put / "===============================" / "Summary: Cincinnati to Rest of Americas - Bulk";   
   data x(drop=_type_ _freq_); set x; 
      file out1 mod dsd;
	   put Port_nameB Port_mesozoneB Frequency;	   	   
