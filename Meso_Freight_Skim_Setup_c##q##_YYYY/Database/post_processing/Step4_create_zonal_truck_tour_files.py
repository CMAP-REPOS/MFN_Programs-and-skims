...
# ----------------------------------------------------------------------------
fltZnData = zoneData.loc[zoneData['origin']==zoneData['destination']].copy()                 ##-- Filter zoneData to keep only intrazonal od pairs
...
otherPairs = zoneData.loc[zoneData['origin']!=zoneData['destination']].copy()             ##-- Filter zoneData to keep only non-intrazonal od pairs
